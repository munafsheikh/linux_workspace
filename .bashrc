...
#alias gitBranch=`if [ currentGitBranch -eq 1 ] then `GITBRANCH=`git branch | grep '*' | cut -f2 -d' '  fi` 
...
#if [ -f ~/git/munafsh/git-shell/src/git-sh.sh ]; then
#    . ~/git/munafsh/git-shell/src/git-sh.sh
#fi
